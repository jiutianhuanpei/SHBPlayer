#
#  Be sure to run `pod spec lint SHBPlayer.podspec' to ensure this is a
...
这是一个视频播放器，支持网络和本地视频播放
  ...
  # Or just: s.author    = "shenhongbang"
  # s.authors            = { "shenhongbang" => "shenhongbang@163.com" }
  # s.social_media_url   = "http://twitter.com/shenhongbang"
